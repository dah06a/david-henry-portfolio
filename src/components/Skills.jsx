                ...
                <Container>
                    <Row className="skill-area">
                        ...
                        <Col sm={12} md={6} lg={4}>
                            <Row className="my-5">
                                <Col xs={6}>
                                    <Image className="nucamp-badge" src={BootstrapBadge} />
                                </Col>
                                <Col xs={6}>
                                    <Image className="nucamp-badge" src={ReactBadge} />
                                </Col>
                            </Row>
                            <Row className="my-5">
                                <Col xs={6}>
                                    <Image className="nucamp-badge" src={ReactNativeBadge} />
                                </Col>
                                <Col xs={6}>
                                    <Image className="nucamp-badge" src={BackendBadge} />
                                </Col>
                            </Row>
                        </Col>
                        <Col sm={12} md={4}>
